package com.gurutelecom.actiondriver;
...
import com.gurutelecom.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean findElement(WebDriver driver, WebElement ele) {
		...
		try {
			...
			if (flag) {
				System.out.println("Successfully Found element at : " +Action.getXpath(ele) );

			} else {
				System.out.println("Unable to locate element at : "+ Action.getXpath(ele));
			}
		}
		return flag;
	}
	...
	public boolean isDisplayed(WebDriver driver, WebElement ele) {
		...
		if (flag) {
			...
			if (flag) {
				System.out.println("The element is Displayed at : " + Action.getXpath(ele));
			} else {
				System.out.println("The element is not Displayed : "+ Action.getXpath(ele));
			}
		} else {
	...
	@Override
	public void explicitWaitClickable(WebDriver driver, WebElement element, int timeOut ) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
